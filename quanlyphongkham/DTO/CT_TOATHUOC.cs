...
namespace quanlyphongkham.DTO
{
    class CT_TOATHUOC
    {
        ...
        string ctt_dvt;
        public string Ctt_dvt
        {
            get { return ctt_dvt; }
            set { ctt_dvt = value; }
        }

        string ctt_dangthuoc;
        public string Ctt_dangthuoc
        {
            get { return ctt_dangthuoc; }
            set { ctt_dangthuoc = value; }
        }

        float ctt_sang;
        public float Ctt_sang
        {
            get { return ctt_sang; }
            set { ctt_sang = value; }
        }
