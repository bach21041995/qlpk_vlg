    ...
    class DAO_CT_TOATHUOC
    {
        ...
        public bool InsertCTTT(CT_TOATHUOC t)
        {
            try
            {
                ...
                cmd.Parameters.Add("@CTT_DVT", SqlDbType.NVarChar, 10);
                ...
                cmd.Parameters.Add("@CTT_DANGTHUOC", SqlDbType.NVarChar, 100);
                ...
                cmd.Parameters["@CTT_DANGTHUOC"].Value = t.Ctt_dangthuoc;
